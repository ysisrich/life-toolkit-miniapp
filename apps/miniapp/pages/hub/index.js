  ...
  data: {
    ...
    tools: [
      ...
      },
      {
        id: 'ai-assistant',
        name: 'AI 习惯助手',
        icon: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white"><path d="M19 8h-1.17c-.41-1.16-1.15-2.18-2.12-2.92L17.3 3.5c.39-.39.39-1.02 0-1.41a.995.995 0 0 0-1.41 0L13.8 4.19C13.23 4.07 12.62 4 12 4s-1.23.07-1.8.19L8.11 2.09a.995.995 0 0 0-1.41 0c-.39.39-.39 1.02 0 1.41L8.29 5.08C7.32 5.82 6.58 6.84 6.17 8H5c-1.1 0-2 .9-2 2v4c0 1.1.9 2 2 2h1.17c.41 1.16 1.15 2.18 2.12 2.92l-1.59 1.59c-.39.39-.39 1.02 0 1.41.39.39 1.02.39 1.41 0l2.09-2.09c.57.12 1.18.19 1.8.19s1.23-.07 1.8-.19l2.09 2.09c.39.39 1.02.39 1.41 0 .39-.39.39-1.02 0-1.41l-1.59-1.59c.97-.74 1.71-1.76 2.12-2.92H19c1.1 0 2-.9 2-2v-4c0-1.1-.9-2-2-2zM9 13c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm6 0c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z"/></svg>',
        gradient: 'linear-gradient(135deg, rgba(48, 209, 88, 0.6) 0%, #000 100%)',
        path: '/pages/tools/ai-assistant/index'
      },
